...
Ex_Length <- read_csv("../example_data/Kendal-Freedman_BIOL125_Example-Length.csv", show_col_types = FALSE)
Ex_Germination <- read_csv("../example_data/Kendal-Freedman_BIOL125_Example-Germination.csv", show_col_types = FALSE)
...
```{r, echo=FALSE}
ex_len <- head(Ex_Length)
knitr::kable(ex_len, caption = "Example length data collection")
```

```{r, echo=FALSE}
ex_germ <- head(Ex_Germination)
knitr::kable(ex_germ, caption = "Example germination data collection")
```
